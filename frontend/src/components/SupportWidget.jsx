...
const MotionButton = lazy(() => import('framer-motion').then(mod => ({ default: mod.m.button })));
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end">
        ...
        <Suspense fallback={
          <button className="relative group flex items-center justify-center gap-3 w-14 h-14 sm:w-auto sm:h-auto sm:px-6 sm:py-4 bg-gradient-to-r from-primary to-emerald-700 text-bg rounded-full shadow-[0_20px_50px_rgba(45,184,122,0.3)] overflow-hidden">
          ...
          >
            ...
            {/* Unread Badge - Positioned relative to the icon area */}
      ...
      <AnimatePresence>
        {isOpen && (
          <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 sm:p-6">
            {/* Dark Backdrop */}
            <Suspense fallback={<div className="absolute inset-0 bg-black/60 backdrop-blur-sm" />}>
              <MotionDiv
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
            ...
            {/* Centered Modal */}
            <Suspense fallback={<div className="relative w-full max-w-[420px] bg-card border border-white/10 rounded-[2.5rem] h-[60vh]" />}>
              <MotionDiv
                      ...
                      {quickHelp.map((item, i) => (
                        ...
                        >
                          ...
                          >
                            ...
                            <Suspense fallback={<ChevronRight size={16} />}>
                              <MotionDiv
