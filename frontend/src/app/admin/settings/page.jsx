    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="grid gap-6">
        ...
        <section className="bg-card border border-border rounded-xl overflow-hidden">
          <div className="p-6 border-b border-border bg-bg/30 flex items-center gap-3">
            <Globe className="text-primary" size={20} />
            <h2 className="font-bold text-text">System Preferences</h2>
          </div>
          <div className="p-6 space-y-4">
        ...
        <section className="bg-card border border-border rounded-xl overflow-hidden">
          ...
          <div className="p-6">
            <div className="flex items-center gap-3">
              ...
              <label htmlFor="email_notif" className="text-sm text-text">Receive email alerts for new bug reports</label>
            </div>
          </div>
        </section>
      </div>
