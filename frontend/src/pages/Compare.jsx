...
const Compare = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 md:space-y-12 py-4 md:py-8 px-4">
      <Helmet>
        <title>Compare Islamic Names | Side-by-Side Analysis | IslamicNames</title>
        <meta name="description" content="Use our advanced comparison tool to analyze two Islamic names side-by-side. Compare meanings, origins, and Quranic references to find the best name." />
