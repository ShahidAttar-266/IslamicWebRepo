...
const Disclaimer = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <Helmet>
        <title>Disclaimer | IslamicNames</title>
        <meta name="description" content="Read the disclaimer policy for IslamicNames regarding the name information and meanings." />
        <link rel="canonical" href="https://www.islamicnames.in/disclaimer" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:title" content="Disclaimer | IslamicNames" />
        <meta property="og:description" content="Read the disclaimer policy for IslamicNames regarding the name information and meanings." />
        <meta property="og:url" content="https://www.islamicnames.in/disclaimer" />
