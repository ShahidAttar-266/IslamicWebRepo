      ...
      <div className="bg-card border border-border rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-primary/5">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-text-muted leading-relaxed">
          ...
          <section>
            ...
            <p>
              We may collect personal information including your name, email address, account details, device information, IP address, browser type, and usage data when you interact with our platform. We do not process any financial or payment information as our services are provided free of charge.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <li>Manage user accounts and favorite lists</li>
          ...
          <section>
            <h2 className="text-xl font-bold text-text mb-4 flex items-center gap-2">
              <span className="text-primary text-sm font-black">04.</span> Data Security
            </h2>
            <p>
              We implement reasonable technical and organizational security measures to protect user information from unauthorized access, misuse, disclosure, or alteration. As we do not process payments, no credit card or banking data is collected or stored on our servers.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-text mb-4 flex items-center gap-2">
              <span className="text-primary text-sm font-black">07.</span> User Rights
            </h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text mb-4 flex items-center gap-2">
              <span className="text-primary text-sm font-black">08.</span> Children's Privacy
            </h2>
            <p>
